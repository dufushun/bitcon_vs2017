...
QT_MOC_LITERAL(6, 55, 6) // "Amount"
    ...
    "unitChanged\0idx\0value\0Amount"
};
...
void BitcoinAmountField::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< Amount*>(_v) = _t->value(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setValue(*reinterpret_cast< Amount*>(_v)); break;
        default: break;
        }
